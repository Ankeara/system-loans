    ...
    <main class="flex-1 overflow-auto">
        ...
        <header
            ...
            <div class="block">
                ...
                <div class="flex items-center justify-between px-5">
                    <span class="text-xl text-gray-600 hidden lg:block">អតិថិជនដែលបានបកការប្រាក់កម្ចី</span>
                </div>
            </div>
        ...
        <div class="p-6 khmer__font">
            <div class="flex items-center justify-between">
                <nav aria-label="Breadcrumb" class="">
                    <ol class="flex items-center gap-1 text-sm text-gray-600">
                        ...
                        <li>
                            <a href="#" class="block transition-colors hover:text-teal-500"> អតិថិជនដែលបានបកការប្រាក់កម្ចី </a>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="header__btn__search flex items-center justify-between mt-6">
                <span class="text-xl text-gray-600">អតិថិជនដែលបានបកការប្រាក់កម្ចីទាំងអស់</span>
            ...
            <script>
                ...
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    function displayPage(page) {
                        ...
                        if (totalItems === 0) {
                            tableBody.innerHTML = '<tr><td colspan="14" class="p-4 text-center">មិនមានអតិថិជនបានបកការប្រាក់កម្ចីទេ</td></tr>';
                        } else {
