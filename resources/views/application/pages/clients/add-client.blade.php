...
@section('content')
    <main class="flex-1 overflow-auto">
        ...
        <div class="p-6 khmer__font">
            ...
            <div class=" mt-10">
                <form method="POST" id="formSaveClient" name="formSaveClient" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
                        <div class="h-auto rounded bg-white">
                            <label for="full_Name">
                                ...
                                <div class="relative">
                                    <input type="text" id="full_Name" placeholder="បញ្ចូលឈ្មោះ" name="full_Name"
                            ...
                            <label for="gender">
                                ...
                                <div class="relative">
                                    <select id="gender" name="gender"
                                        class=" mb-5 bg-[#F9F9F9] w-full text-gray-400 rounded-[8px] border-gray-200 px-3 h-10 text-sm shadow mt-1 border-none sm:text-sm focus:outline-none focus:ring-teal-500 focus:ring-2">
                            ...
                            <label for="phone_Number">
                                ...
                                <div class="relative">
                                    <input type="text" id="phone_Number" placeholder="បញ្ចូលលេខទូរសព្ទ" name="phone_Number"
                            ...
                            <label for="address">
                                ...
                                <div class="relative">
                                    <textarea id="" cols="30" rows="10" name="address"
                                        ...
                                        id="" placeholder="បញ្ចូលអាសាយដ្ឋាន"></textarea>
                                </div>
                                <p></p>
                            </label>
                        </div>
...
@push('scripts_multiple')
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
        ...
        $('#formSaveClient').submit(function (e) {
                e.preventDefault();
                ...
                $('#formSaveClient input[type="text"], #formSaveClient textarea').each(function () {
                    let input = $(this);
                ...
                $.ajax({
                    url: "{{ route('application.pages.clients.save-client') }}",
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
