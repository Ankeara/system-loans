        ...
        <header
            ...
            <div class="block">
                ...
                <div class="flex items-center justify-between px-5">
                    <span class="text-xl text-gray-600 hidden lg:block">អតិថិជនដែលបានចងការប្រាក់ខ្ពស់ជាលុយបាត</span>
                </div>
            </div>
        ...
        <div class="p-6 khmer__font">
            <div class="flex items-center justify-between">
                <nav aria-label="Breadcrumb" class="">
                    <ol class="flex items-center gap-1 text-sm text-gray-600">
                        ...
                        <li>
                            <a href="#" class="block transition-colors hover:text-teal-600"> អតិថិជនដែលបានចងការប្រាក់ខ្ពស់ជាលុយបាត </a>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="grid grid-cols-1 gap-4 mt-10 lg:grid-cols-3 lg:gap-8">
                    ...
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-1 lg:gap-4 h-full">
                        <a href="{{ route("application.pages.loans.loan") }}"
                            ...
                            <div class="flex flex-col items-center justify-center mb-4 text-gray-600">
                                <span class="text-4xl mb-4">{{ $highLoanBahtCount }}</span>
                ...
                <div class="chart h-[400px] border border-gray-100 shadow-sm rounded lg:col-span-2">
                    <canvas id="chartLoanHighBaht"></canvas>
                </div>
            </div>
        </div>
    </main>
...
@push('scripts_chart_loan')
    <script>
       document.addEventListener('DOMContentLoaded', function () {
            const ctx = document.getElementById('chartLoanHighBaht').getContext('2d');
            const chart = new Chart(ctx, {
                type: 'bar', // ប្រភេទតារាងជាបារ
                data: {
                    labels: ['ចំនួនប្រាក់កម្ចីខ្ពស់សរុប', 'ប្រាក់កម្ចីខ្ពស់ (≥ ៥ សែនបាត)'],
                    datasets: [{
                        label: 'ចំនួនប្រាក់កម្ចី',
                        data: [{{ $highLoanBahtCount }}, {{ $highLoanBahtCount }}],
