        ...
        <header
            ...
            <div class="block">
                ...
                <div class="flex items-center justify-between px-5">
                    <span class="text-xl text-gray-600 hidden lg:block">អតិថិជនដែលបានចងការប្រាក់ខ្ពស់ជាលុយដុល្លា</span>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                <nav aria-label="Breadcrumb" class="">
                    <ol class="flex items-center gap-1 text-sm text-gray-600">
                        ...
                        <li>
                            <a href="#" class="block transition-colors hover:text-teal-600"> អតិថិជនដែលបានចងការប្រាក់ខ្ពស់ជាលុយដុល្លា </a>
                        </li>
                    </ol>
                </nav>
                    ...
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-1 lg:gap-4 h-full">
                        <a href="{{ route("application.pages.loans.loan") }}"
                            ...
                            <div class="flex flex-col items-center justify-center mb-4 text-gray-600">
                                <span class="text-4xl mb-4">{{ $highLoanDollarCount }}</span>
    ...
    <script>
       document.addEventListener('DOMContentLoaded', function () {
            ...
            const chart = new Chart(ctx, {
                ...
                data: {
                    labels: ['ចំនួនប្រាក់កម្ចីខ្ពស់សរុប', 'ប្រាក់កម្ចីខ្ពស់ (≥ ៥ ពាន់ដុល្លា)'],
                    datasets: [{
                        label: 'ចំនួនប្រាក់កម្ចី',
                        data: [{{ $highLoanDollarCount }}, {{ $highLoanDollarCount }}],
