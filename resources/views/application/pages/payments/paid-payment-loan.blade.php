    ...
    <main class="flex-1 overflow-auto">
        ...
        <header
            ...
            <div class="block">
                ...
                <div class="flex items-center justify-between px-5">
                    <span class="text-xl text-gray-600 hidden lg:block">អ្នកបានបង់ការប្រាក់សរុបថ្ងៃនេះ</span>
                </div>
            </div>
        ...
        <div class="p-6 khmer__font">
            <div class="flex items-center justify-between">
                <nav aria-label="Breadcrumb" class="">
                    <ol class="flex items-center gap-1 text-sm text-gray-600">
                        ...
                        <li>
                            <a href="#" class="block transition-colors hover:text-teal-500"> អ្នកបានបង់ការប្រាក់សរុបថ្ងៃនេះ
                            </a>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="header__btn__search flex items-center justify-between mt-6">
                <span class="text-xl text-gray-600">អ្នកបានបង់ការប្រាក់សរុបថ្ងៃនេះ</span>
            ...
            <div class="mt-10">
                <div class="flex items-center justify-between flex-wrap mb-6">
                    <p class="mt-1 line-clamp-1 text-sm text-teal-600">អ្នកបានបង់ការប្រាក់សរុបថ្ងៃនេះ <span
                            class="font-bold count">({{ $loans->count() }} នាក់)</span></p>
                </div>
                <div
                        ...
                        <div class="client__payment h-full w-full rounded relative container-div">
                            <article
                                ...
                                <div class="bg-white p-4 relative sm:p-2 w-full h-[40%]">
                                    <div class="pt-2 pb-2">
                                        <h1
                                        class="text-sm text-gray-600 xl:text-lg lg:text-lg md:text-[18px] sm:text-[30px]">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p class="mt-1 line-clamp-1 text-xs text-teal-600">បានបង់ការប្រាក់ថ្ងៃនេះ</p>
                                    </div>
                                </div>
                            </article>
                        </div>
                    @empty
                        <div class="col-span-2 w-full ">
                            <p class="text-gray-600 text-center">មិនមានអតិថិជនបានបង់ការប្រាក់ថ្ងៃនេះទេ</p>
                        </div>
                    @endforelse
                </div>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#searchButton').click(function () {
                ...
                $('.client__payment').each(function () {
                    let clientName = $(this).find('h1').text().toLowerCase();
                ...
                // Update the count
                let visibleCount = $('.client__payment:visible').length;
                $('.count').text(`(${visibleCount} នាក់)`);
            });

            // Clear button functionality
            $('#clearButton').click(function () {
                $('#Search').val('');
                $('.client__payment').show();

                // Reset to original count
                let totalCount = {{ $loans->count() }};
                $('.count').text(`(${totalCount} នាក់)`);
            });

            // Optional: Add real-time search when typing
